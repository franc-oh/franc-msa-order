...
@EnableJpaRepositories(
        basePackages = {"com.franc.domain.order.repository"},
...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("dataSource") DataSource dataSource) {
        ...
        factoryBean.setPackagesToScan(new String[] {"com.franc.domain.order.domain"}); // Entity 패키지 경로
        ...
        jpaProperties.setProperty("hibernate.format_sql", env.getRequiredProperty("spring.jpa.properties.hibernate.format_sql"));
